...
describe(Store) do
  describe("#brands") do
    it("tells which brands are in this store") do
      ...
      test_brand1 = Brand.create({:name => "nike", :description => "large brand", :store_id => test_store.id})
      test_brand2 = Brand.create({:name => "adidas", :description => "large brand", :store_id => test_store.id})
